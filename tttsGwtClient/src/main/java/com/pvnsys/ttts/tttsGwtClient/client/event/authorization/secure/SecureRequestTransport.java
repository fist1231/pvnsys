package com.pvnsys.ttts.tttsGwtClient.client.event.authorization.secure;
...
public class SecureRequestTransport extends DefaultRequestTransport {
    ...
    public SecureRequestTransport(EventBus eventBus) {
        this.eventBus = eventBus;
	    String requestURL = GWT.getHostPageBaseURL() + "secureRequest"; 
